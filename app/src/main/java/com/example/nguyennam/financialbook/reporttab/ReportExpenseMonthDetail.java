...
public class ReportExpenseMonthDetail extends Fragment {
    ...
    private void setDataForReport() {
        ...
        String monthOfYear = FileHelper.readFile(context, Constant.TEMP_BUDGET_DATE);
        for (int i = 0; i < dateExpenseList.size(); i++) {
            String month = CalendarSupport.getMonthOfYear(dateExpenseList.get(i));
