...
public class ReportSelectAccount extends Fragment implements View.OnClickListener, ReportSelectAccountAdapter.AccountOnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ReportSelectAccountAdapter myAdapter = new ReportSelectAccountAdapter(context, data);
    ...
    public void onClick(int position) {
        ...
        FileHelper.writeFile(context, Constant.TEMP_ID, accountID);
