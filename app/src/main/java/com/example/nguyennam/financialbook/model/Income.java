...
public class Income {
    ...
    public Income(int _id, String _amountMoney, String _category, String _description, int _accountID, String _date, String _event) {
        this._id = _id;
    ...
    public Income(String _amountMoney, String _category, String _description, int _accountID, String _date, String _event) {
        this._amountMoney = _amountMoney;
        this._category = _category;
        this._description = _description;
        this._accountID = _accountID;
